...
// #### @target {Object} Logger instance calling this transport.
...
//
DailyRotateFile.prototype.log = function (target, level, msg, meta, callback) {
  if (this.silent) {
  ...
  var output = common.log({
    level:       level,
    levelLength: target.levelLength,
    message:     msg,
    meta:        meta,
    json:        this.json,
